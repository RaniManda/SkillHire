...
const testimonials = [
  {
    ...
    comment:
      "The resume builder helped me identify gaps I didn’t even know existed.",
    rating: 5,
  },
  {
    ...
    comment:
      "The platform helped me balance technical details with clear explanations.",
    rating: 5,
  },
  {
    name: "Karthik",
    ...
    comment:
      "Mock interviews made me confident before the real one.",
    rating: 4,
  },
  {
    name: "Abhiram",
    ...
    comment:
      "AI feedback was honest and constructive.",
    rating: 5,
  },
];

const Testimonials = ({ onAuth }) => {
  return (
  ...
  />
        ...
        <div className="feedback-text-card">
          ...
          <button onClick={() => onAuth("register", "feedback")}>
  Give Feedback
</button>
