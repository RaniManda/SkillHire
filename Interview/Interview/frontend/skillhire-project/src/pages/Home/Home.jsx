...
const Home = ({ onAuth, isDarkMode, toggleTheme, onGiveFeedback, topFeedbacks = [] }) => {
  ...
  return (
    <div className={`home-page-wrapper ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <main className="main-layout">
        ...
        <Testimonials onAuth={onAuth} onGiveFeedback={onGiveFeedback} testimonials={topFeedbacks} />
